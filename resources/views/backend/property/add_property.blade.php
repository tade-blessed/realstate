                        ...
                        <h6 class="card-title">Add Property</h6>
                            <form  id="myForm" method="POST" action="{{route('store.property')}}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label class="form-group form-label">Main Thambnail</label>
                                            <input type="file" name="property_thambnail" class="form-control" onchange="mainThambUrl(this)" >
                                            <img src="" id="mainThmb">
                                        </div>
                                    </div><!-- Col -->
                                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <a href="https://www.latlong.net/" target="_blank">go here to get latitude</a>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="longtude" class="form-control">
                                            <a href="https://www.latlong.net/" target="_blank">go here to get longtude</a>
                                        </div>
                                    </div><!-- Col -->
                                </div><!-- Row -->
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-4">
                                            ...
                                            <select name="amenitis_id[]" class="js-example-basic-multiple form-select" multiple="multiple" data-width="100%">
                                                @foreach($amenities as $amenitie)
                                                <option value={{"$amenitie->id"}}>{{$amenitie->amenitis_name}}</option>
            ...
            $(document).ready(function (){
                $('#myForm').validate({
                    ...
                    messages :{
                        ...
                        property_thambnail: {
                            required : 'Please Enter Property thambnail',
                        }, 
